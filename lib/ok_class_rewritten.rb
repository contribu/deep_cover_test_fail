...
($_cov ||= {})[0]||=Array.new(37,0);$_cov[0][36]+=1;_temp=nil;((_temp=(class OkClassRewritten
  $_cov[0][35]+=1;((_temp=(def (self).my_class_method(
    ...
    $_cov[0][33]+=1;_temp=nil;x
  end);$_cov[0][32]+=1;_temp=_temp))
end);$_cov[0][34]+=1;_temp=_temp))
